// Comprehensive Global Petroleum Benchmark Dataset with Detailed Policy & Fiscal Taxonomy
export const petroleumData = [
  {
    ...
    oilReserveSpr: {
      ...
      survivalDaysNoImport: 365,
      survivalCategory: "Net Exporter (>365 Days)",
      dailyConsumptionBpd: "~180,000 bpd",
      netImportReliance: "0% (Net Exporter)",
      emergencyScenarioNote: "Domestic crude production covers internal demand; main emergency risk is refinery breakdown & heavy diluent shortages.",
  ...
  },
  {
    ...
    oilReserveSpr: {
      ...
      survivalDaysNoImport: 365,
      survivalCategory: "Net Exporter (>365 Days)",
      dailyConsumptionBpd: "~3.2 Million bpd",
      netImportReliance: "0% (Net Exporter)",
      emergencyScenarioNote: "Fully self-sufficient; 5M bpd East-West bypass pipeline ensures crude export & domestic refinery crude supply during Hormuz crises.",
  ...
  },
  {
    ...
    oilReserveSpr: {
      ...
      survivalDaysNoImport: 365,
      survivalCategory: "Net Exporter (>365 Days)",
      dailyConsumptionBpd: "~1.8 Million bpd",
      netImportReliance: "0% (Net Exporter)",
      emergencyScenarioNote: "Crude production far exceeds domestic needs; ~71M bbls floating VLCC storage provides domestic refining buffer during sanctions.",
  ...
  },
  {
    ...
    oilReserveSpr: {
      ...
      survivalDaysNoImport: 365,
      survivalCategory: "Net Exporter (>365 Days)",
      dailyConsumptionBpd: "~850,000 bpd",
      netImportReliance: "0% Crude Import Reliance (~15% Refined Gasoline Import Reliance)",
      emergencyScenarioNote: "Self-sufficient in crude oil; Karbala and Baiji refinery expansions reduce refined fuel import vulnerability during emergencies.",
  ...
  },
  {
    ...
    oilReserveSpr: {
      ...
      survivalDaysNoImport: 365,
      survivalCategory: "Net Exporter (>365 Days)",
      dailyConsumptionBpd: "~1.0 Million bpd",
      netImportReliance: "0% (Net Exporter)",
      emergencyScenarioNote: "Ruwais mega-refining hub & Fujairah deepwater tank farms (34M bbls) provide over 365 days of domestic fuel autonomy.",
  ...
  },
  {
    ...
    oilReserveSpr: {
      ...
      survivalDaysNoImport: 365,
      survivalCategory: "Net Exporter (>365 Days)",
      dailyConsumptionBpd: "~450,000 bpd",
      netImportReliance: "0% (Net Exporter)",
      emergencyScenarioNote: "Al-Zour 615k bpd mega-refinery + Mina Al-Ahmadi terminals cover 100% of national energy needs without imports.",
  ...
  },
  {
    ...
    oilReserveSpr: {
      ...
      survivalDaysNoImport: 365,
      survivalCategory: "Net Exporter (>365 Days)",
      dailyConsumptionBpd: "~3.6 Million bpd",
      netImportReliance: "0% (Net Exporter)",
      emergencyScenarioNote: "Transneft 50,000 km trunk pipeline network float guarantees continuous domestic refinery feedstock and self-sufficiency.",
  ...
  },
  {
    ...
    oilReserveSpr: {
      ...
      survivalDaysNoImport: 120,
      survivalCategory: "IEA Compliant (~120 Days)",
      dailyConsumptionBpd: "~20.3 Million bpd",
      netImportReliance: "Net Exporter overall (~12% gross crude import reliance)",
      emergencyScenarioNote: "Department of Energy Strategic Petroleum Reserve (~415M bbls salt caverns) + 13M bpd domestic crude output provides ~120+ days of total isolation buffer.",
  ...
  },
  {
    ...
    oilReserveSpr: {
      ...
      survivalDaysNoImport: 100,
      survivalCategory: "IEA Compliant (~100 Days)",
      dailyConsumptionBpd: "~16.0 Million bpd",
      netImportReliance: "72% Net Import Reliance (~11.5M bpd net imports)",
      emergencyScenarioNote: "Strategic reserve bases (Zhoushan, Dalian, etc. ~1.3-1.4B bbls) deliver ~90-100 days of complete import cut-off protection.",
  ...
  },
  {
    ...
    oilReserveSpr: {
      ...
      survivalDaysNoImport: 45,
      survivalCategory: "Moderate Buffer (~45 Days)",
      dailyConsumptionBpd: "~3.0 Million bpd",
      netImportReliance: "Net Exporter Crude (~25% Diesel Import Reliance)",
      emergencyScenarioNote: "Pre-Salt crude production provides crude autonomy, but commercial refined diesel stock buffer is ~30-45 days during severe maritime embargoes.",
